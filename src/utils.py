...
def sample(model, noise_scheduler, out_path, loader, constants=None, conditional=True, device='cpu', idx=None, sigma_noise=0):
    """
    ...
    guide = None
    if conditional:
        guide = add_gaussian_noise(loader.dataset[idx][1].unsqueeze(0).to(device), sigma=sigma_noise)
