...
from utils import sample, get_constants, add_gaussian_noise, blackout_pixels, sample_gas, sample_all
...
def parse_args():
    ...
    parser.add_argument("--out_path", type=str, required=False, default="/groups/mlprojects/dm_diffusion/model_out/FRB/", help="Path to save models.")
    # Experiments
...
def main(args):
    ...
    config = {
        ...
        "gas_file": f"/groups/mlprojects/dm_diffusion/data/Maps_Mgas_{args.dataset}_LH_z=0.00.npy", # TODO: add lensing file
    ...
    transform_gas = transforms.Compose([
        ...
        transforms.Lambda(lambda img: blackout_pixels(img, percentage=10)),  # Blackout 90% of pixels
    ])
